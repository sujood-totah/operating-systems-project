...
| `m1_example1_path.txt` | 1 | Course autograder-style graph; last line `0 5` → `0 -> 2 -> 5` / `12`. |
| `m1_multi_traveler.txt` | 4+ | Multi-traveler format (`T` line); used by GUI milestones, **not** milestone 1 CLI. |
